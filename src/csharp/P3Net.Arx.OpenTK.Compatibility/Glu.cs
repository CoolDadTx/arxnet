...
#pragma warning disable IDE0049 //Use type aliases

namespace OpenTK.Graphics
{
#pragma warning disable IDE0065 //Put using statements outside namespace
    using System;
    using System.Runtime.InteropServices;
    using OpenTK.Graphics.OpenGL;
#pragma warning restore IDE0065 //Put using statements outside namespace

    public static partial class Glu
    {
        public static int Build2DMipmap ( TextureTarget target, int internalFormat, int width, int height, PixelFormat format, PixelType type, [In, Out] object data )
        {
            unsafe
            {
                ...
                try
                {
                    return Delegates.gluBuild2DMipmaps(target, internalFormat, width, height, format, type, data_ptr.AddrOfPinnedObject());
                } finally
                {
                    data_ptr.Free();
                }                
        ...
        {
            Delegates.gluPerspective(fovy, aspect, zNear, zFar);
        }
