...
namespace P3Net.Arx
{
    ...
    {        
        ...
        public static SpellRecord[] spells =
        {
            ...
            new SpellRecord() { name = "Position", percentage = 50, cost = 42, effect = 10, negativeValue = 10, positiveValue = 0, duration = 1, guilds = new [] {false, true, true, true, true, true, true, true, true, true, true, true, true, false } },
        ...
        private static void AttemptSpell ( int spellRef )
        {
        ...
        private static void CastSpellMessage ( string spellDesc )
        {
        ...
        private static void SpellBackfiredMessage ( int spellPoints )
        {
            var keynotpressed = true;
            while (keynotpressed)
            {
