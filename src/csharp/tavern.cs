...
namespace P3Net.Arx
{
	...
	*/
		...
		while (tavernMenu == 22) // Attempt to buy a club membership
		{
				...
				{
					//MLT: Downcast to int
					int roundCost = (int)(80 * Taverns[tavernNo].priceFactor);
					TavernDisplayUpdate();
	...
	//==============================================================================
		...
		{
			new Tavern() { name = "Flaming Dragon", priceFactor = 1.2F, location = 23, openingHour = 0, closingHour = 23, jobProbability = 51, membershipFee = 0, classy = false },
			new Tavern() { name = "Misty Mountain", priceFactor = 3.5F, location = 24, openingHour = 11, closingHour = 2, jobProbability = 51, membershipFee = 3000, classy = true },
			new Tavern() { name = "Screaming Siren Bar", priceFactor = 1.2F, location = 25, openingHour = 16, closingHour = 3, jobProbability = 64, membershipFee = 0, classy = false },
			new Tavern() { name = "Happy Hunter Rest Stop", priceFactor = 1.4F, location = 26, openingHour = 0, closingHour = 7, jobProbability = 77, membershipFee = 0, classy = false },
			new Tavern() { name = "Dancing Nymph", priceFactor = 1.6F, location = 27, openingHour = 16, closingHour = 7, jobProbability = 72, membershipFee = 0, classy = false },
			new Tavern() { name = "Club", priceFactor = 3.5F, location = 28, openingHour = 18, closingHour = 22, jobProbability = 182, membershipFee = 1500, classy = true },
			new Tavern() { name = "Black Devil", priceFactor = 1.4F, location = 29, openingHour = 0, closingHour = 5, jobProbability = 64, membershipFee = 0, classy = true },
			new Tavern() { name = "Lost Oasis", priceFactor = 0.8F, location = 30, openingHour = 0, closingHour = 23, jobProbability = 26, membershipFee = 0, classy = true },
			new Tavern() { name = "Last Stop", priceFactor = 1.2F, location = 31, openingHour = 0, closingHour = 23, jobProbability = 38, membershipFee = 0, classy = false },
			new Tavern() { name = "Tail of the Dog", priceFactor = 2.0F, location = 32, openingHour = 0, closingHour = 23, jobProbability = 192, membershipFee = 0, classy = false },
			new Tavern() { name = "Club Babylon", priceFactor = 5.0F, location = 33, openingHour = 10, closingHour = 4, jobProbability = 77, membershipFee = 50000, classy = true },
			new Tavern() { name = "Lost Tears", priceFactor = 1.8F, location = 34, openingHour = 0, closingHour = 23, jobProbability = 56, membershipFee = 0, classy = true },
			new Tavern() { name = "Mom's Bar", priceFactor = 1.6F, location = 35, openingHour = 0, closingHour = 23, jobProbability = 128, membershipFee = 0, classy = false },
			new Tavern() { name = "Lusty Lloyds", priceFactor = 1.0F, location = 36, openingHour = 0, closingHour = 23, jobProbability = 46, membershipFee = 0, classy = false }
		};

		public static TavernDrinkItem[] tavernDrinks =
		{
			new TavernDrinkItem() { name = "Water Flask", basePrice = 5, alcoholAdded = 0, thirstRemoved = 0, waterFlaskAdded = 1 },
			new TavernDrinkItem() { name = "Milk", basePrice = 2, alcoholAdded = 0, thirstRemoved = 6, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Beer", basePrice = 2, alcoholAdded = 1, thirstRemoved = 2, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Ale", basePrice = 3, alcoholAdded = 1, thirstRemoved = 3, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Wine", basePrice = 4, alcoholAdded = 2, thirstRemoved = 2, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Grog", basePrice = 2, alcoholAdded = 2, thirstRemoved = 2, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Spirits", basePrice = 5, alcoholAdded = 2, thirstRemoved = 2, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Water", basePrice = 1, alcoholAdded = 0, thirstRemoved = 8, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Sarsaparila", basePrice = 3, alcoholAdded = 0, thirstRemoved = 5, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Orange Juice", basePrice = 3, alcoholAdded = 0, thirstRemoved = 5, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Grape Juice", basePrice = 3, alcoholAdded = 0, thirstRemoved = 5, waterFlaskAdded = 0 },
			new TavernDrinkItem() { name = "Mineral Water", basePrice = 2, alcoholAdded = 0, thirstRemoved = 8, waterFlaskAdded = 0 }
		};

		public static TavernFoodItem[] tavernFoods =
		{
			new TavernFoodItem() { name = "Rack of Lamb", basePrice = 40, hungerRemoved = 16, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Roast Beef", basePrice = 50, hungerRemoved = 18, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Roast Chicken", basePrice = 25, hungerRemoved = 16, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Roast Dragon", basePrice = 150, hungerRemoved = 22, foodPacketAdded = 1 },
			new TavernFoodItem() { name = "Pork Ribs", basePrice = 30, hungerRemoved = 12, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Leg of Lamb", basePrice = 80, hungerRemoved = 19, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Fried Chicken", basePrice = 50, hungerRemoved = 15, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Leg of Dragon", basePrice = 300, hungerRemoved = 22, foodPacketAdded = 2 },
			new TavernFoodItem() { name = "Ham", basePrice = 60, hungerRemoved = 14, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Lamb", basePrice = 56, hungerRemoved = 17, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Filet of Beef", basePrice = 70, hungerRemoved = 19, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Vegetable Soup", basePrice = 5, hungerRemoved = 8, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Ragout of Beef", basePrice = 33, hungerRemoved = 10, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Ragout of Dragon", basePrice = 50, hungerRemoved = 11, foodPacketAdded = 1 },
			new TavernFoodItem() { name = "Bowl of Fruit", basePrice = 25, hungerRemoved = 7, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Plate of Greens", basePrice = 18, hungerRemoved = 6, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Smoked Fish", basePrice = 30, hungerRemoved = 12, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Apple Pie", basePrice = 12, hungerRemoved = 4, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Lemon Pie", basePrice = 12, hungerRemoved = 4, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Chocolate Cake", basePrice = 10, hungerRemoved = 4, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Loaf of Bread", basePrice = 8, hungerRemoved = 6, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Block of Cheese", basePrice = 15, hungerRemoved = 9, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Food Packet", basePrice = 25, hungerRemoved = 0, foodPacketAdded = 1 },
			new TavernFoodItem() { name = "Gruel", basePrice = 4, hungerRemoved = 8, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Bagel", basePrice = 6, hungerRemoved = 5, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Pemmican", basePrice = 20, hungerRemoved = 4, foodPacketAdded = 1 },
			new TavernFoodItem() { name = "Bowl of Chili", basePrice = 10, hungerRemoved = 6, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Pasta", basePrice = 30, hungerRemoved = 10, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Lasagna", basePrice = 30, hungerRemoved = 10, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Crayfish", basePrice = 40, hungerRemoved = 9, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Lobster", basePrice = 100, hungerRemoved = 14, foodPacketAdded = 0 },
			new TavernFoodItem() { name = "Sandwich", basePrice = 10, hungerRemoved = 8, foodPacketAdded = 0 }
		};
		...
		{
			new TavernJob() { name = "Bouncer", minIncome = 40, maxIncome = 44, statRequirementName = "Strength", statRequirementValue = 22, fatigueRate = 0.75F, minorWoundProbability = 19.69F, majorWoundProbability = 7.26F },
			new TavernJob() { name = "Host", minIncome = 20, maxIncome = 24, statRequirementName = "Charm", statRequirementValue = 12, fatigueRate = 0.5625F, minorWoundProbability = 0.77F, majorWoundProbability = 0.01F },
			new TavernJob() { name = "Dish Washer", minIncome = 8, maxIncome = 12, statRequirementName = "Skill", statRequirementValue = 9, fatigueRate = 0.5625F, minorWoundProbability = 12.64F, majorWoundProbability = 2.20F }
		};
